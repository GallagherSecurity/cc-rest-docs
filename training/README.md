...
* The ToC is generated by github pages (Jekyll, Kramdown, Maruku).  If you're seeing this, it's
  either because github pages has changed the rules, or
  because you're reading the README.md on github.com instead of https://gallaghersecurity.github.io/
  .  While still in draft form, it is at https://gallaghersecurity.github.io/cc-rest-docs/training
  . {:toc}
