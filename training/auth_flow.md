...
flowchart TD
  ...
  o_needacert(["Raise 'client item needs a fingerprint' alarm,\nreturn 401"]):::red
  o_badprint(["Raise 'incorrect fingerprint' alarm,\nreturn 401"]):::red
  ...
  c_clientcertcheck1{"Is there a fingerprint\non that REST Client item?"}
