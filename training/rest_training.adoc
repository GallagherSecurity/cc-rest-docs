...
The gateway will enforce the REST Client item's source IP restrictions.  If the source IP of your
client's connections will change when you move them from the Command Centre server to the API
gateway, you will need to adjust those restrictions.
