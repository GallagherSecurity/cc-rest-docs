...
=== Do not install the ModHeader extension
...
WARNING:  ⚠ *The ModHeader extension contains malware.  Do not use it.  Try DevHeader instead.  These instructions remain for a suitable alternative.*
