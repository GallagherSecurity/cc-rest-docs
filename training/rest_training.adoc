...
Do you want to learn something about HTTP queries in general?  <<_http_requests>> should help.
...
* There are no licence requirements on top of the API's usual licences.  It's included.
