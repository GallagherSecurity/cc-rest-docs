...
Every item in the API--we will get to items in a moment--is in a division (footnote: except day
...
Or (in 8.70) 'View Cardholder Events' on the division of the cardholder related to the event or
alarm, and a privilege like 'View Site' that allows viewing the source item.
