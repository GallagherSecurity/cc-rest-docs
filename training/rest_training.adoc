...
If you are viewing the single-page version of this document, it is also available in a
link:multipage/[multi-page] version.

If you are viewing the multi-page version of this document, it is also available in a
link:../[single page] (for easier searching and a complete table of contents).
