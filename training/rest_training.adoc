...
Clients in production environments should refuse to talk to a server that offers a certificate that
is not carrying a signature from one of the internet’s signing authorities. A certificate that has
not been paid for, in other words.
