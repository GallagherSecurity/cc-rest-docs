...
asciidoctor -r asciidoctor-diagram -o $D/index.html --verbose rest_training.adoc || true

echo Building PDF from AsciiDoc
asciidoctor-pdf -r asciidoctor-diagram -o $D/rest_training.pdf --verbose rest_training.adoc || true

echo Building multi-page HTML from AsciiDoc
asciidoctor-multipage -r asciidoctor-diagram -D $D -o $D/paged.html --verbose rest_training.adoc || true
